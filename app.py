...
if uploaded_file is not None:
    ...
    # Menampilkan 5 Data Teratas Hasil Import sebagai Preview
    st.write("### Preview Tabel Data Transaksi:")
    st.dataframe(df_raw[["Invoice ID", "Product line", "Unit price", "Quantity", "Sales"]].head())
    
    # INTERACTIVE SLIDER: Pengaturan Bobot Dinamis ditempatkan SEBELUM tombol analisis
    st.markdown("---")
    ...
    if st.button("🚀 Jalankan Analisis"):
        with st.spinner("Sedang memproses algoritma K-Means dan SAW..."):
            ...
            # Mencari cluster dengan rata-rata penjualan (Quantity) terendah (Slow-Moving)
            ...
            # 7. Hitung Skor Akhir berdasarkan Input Slider User
